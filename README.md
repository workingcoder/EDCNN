...
This repository is an official implementation of the paper [EDCNN: Edge enhancement-based Densely Connected Network with Compound Loss for Low-Dose CT Denoising](https://arxiv.org/abs/2011.00139). [`arXiv link`](https://arxiv.org/abs/2011.00139) [`IEEEXplore link`](https://ieeexplore.ieee.org/document/9320928)
